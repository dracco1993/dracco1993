...
- **Elsewhere** — Odds and ends across my own repos, other orgs, and other people's projects (FIRSTMap, redis, and more). [<!--prs:__other-->55<!--/prs--> merged PRs](https://github.com/search?q=author%3Adracco1993+type%3Apr+is%3Amerged+-org%3ARAR1741+-org%3Athe-blue-alliance+-org%3AGreaterGamersLounge+-org%3ACranberryAlarm&type=pullrequests), <!--commits:__other-->560+<!--/commits--> commits.
...
<!-- recent_prs start -->
- [RAR1741/hub](https://github.com/RAR1741/hub/pull/321) — Show an error on /login when Google sign-in fails (2026-09-23)
